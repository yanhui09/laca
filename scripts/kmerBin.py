...
def umap_reduction(kmer_freqs, n_neighbors, low_memory, min_dist, n_components):
    ...
    X_embedded = umap.UMAP(
        random_state=123, n_neighbors=n_neighbors, low_memory = low_memory,
...
def main():
    ...
    X_embedded, umap_out1 = umap_reduction(args.kmer, args.n_neighbors, args.min_dist, args.low_memory, args.n_components)
